...
public class TeacherDialog  extends JDialog{
	//定义界面使用到的组件作为成员变量
			private JLabel tableLabel=new JLabel("学生成绩表");//列表标题
			...
			private JLabel PasswordLabel=new JLabel("姓名");//
			private JLabel NameLabel=new JLabel("Java");//
			private JLabel SexLabel=new JLabel("MySQL");//
			private JLabel CollegeLabel=new JLabel("Andriod");//
			private JLabel MajorLabel=new JLabel("Web");//
			private JLabel StudentClassLabel=new JLabel("English");//
			...
			private JButton addBtn=new JButton("添加学生成绩");//添加水果按钮
			...
			private JButton updateBtn=new JButton("修改学生成绩");//修改水果按钮
			
			//删除功能组件
			protected JTextField delStudentNumberText=new JTextField(6);//添加编号文本框
			private JButton delBtn=new JButton("删除学生成绩");//删除水果按钮
			private AdministratorDao administratorDao = new AdministratorDao();
			
			//构造方法
			public TeacherDialog(String state){
				this(null,true,state);
			}
			
			public TeacherDialog(Frame owner,boolean modal,String state){
				super(owner,modal);
				this.init();//初始化操作
			...
			private void addComponent(String state){
				...
				addBtn.setBounds(850, 400, 120, 25);
				this.add(addBtn);
			...
			private void addListener(){
				...
				addBtn.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e) {
						...
						administratorDao.addScores(teacherData,"scores");
				...
				updateBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e){
						...
						AdministratorDao administratorDao = new AdministratorDao();
						administratorDao.updateTeacher("scores",teacherData.getStudentNumber(),"Name",updatePasswordText.getText());
				...
				delBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e){
						...
						AdministratorDao administratorDao = new AdministratorDao();
						administratorDao.delTeacher("scores",teacherData.getStudentNumber());//,"Password",updatePasswordText.getText()
			...
			public void queryDate(String personnel) {
				...
				String[] thead={"学号","姓名","Java","MySQL","Andriod","Web","English"};
				ArrayList<Data> dataList=administratorDao.queryStudentScores(personnel);
...
//				new TeacherDialog("scores").setVisible(true);
//			}
//			
}
