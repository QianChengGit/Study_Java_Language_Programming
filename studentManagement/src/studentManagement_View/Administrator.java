...
//	private JMenu menu06;
	...
	public Administrator(final String number){
		jf = new JFrame("管理员界面");
		jp = new JPanel();
...
//		menuBar.add(menu06);
		...
		item02.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new Student_Message("administrator", number).setVisible(true);
			}
		});
		item03.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				AdministratorDialog administratorDialog= new AdministratorDialog("teacher");
...
//		
	...
	public static void main(String[] args) {
		new Administrator("201701081001a");
	}
