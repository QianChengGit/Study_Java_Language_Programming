...
public class Student_Scores  extends JDialog{
	//标签
		...
		//构造方法
				public Student_Scores(String state,String number){
					this(null,true,state,number);
				}
				
				public Student_Scores(Frame owner,boolean modal,String state,String number){
					super(owner,modal);
					this.init();//初始化操作
		...
		public String[][] queryDate(String personnel,String StudentNumber) {
			...
			ArrayList<Data> dataList=administratorDao.SelectStudentScores(personnel, StudentNumber);
		...
		public static void main(String[] args) {
			new Student_Scores("scores","201701081001").setVisible(true);
		}
}
